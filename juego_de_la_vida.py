...
from generar_reglas import generar_regla_0, generar_regla_11, generar_regla_24, generar_regla_34, generar_regla_1
...
def main ():
    matriz = generar_regla_11( FILAS_MATRIZ, COLUMNAS_MATRIZ )
